...
{
    this->base = other.base;///ii dam baza lui other
    this->base10 = other.base10;///ii dam nr in b10
...
Number::Number(Number&& other) ///constructorul de mutare -> muta si sterge other
{
    ...
    other.base = 0;///o stergem din other
    other.base10 = 0;///il stergem din other
    int lg = 0;///calculam lg lui as_char din other pt a putea aloca memorie pt as_char din this
    while (other.as_char[lg] != '\0') lg++;///nr se termina cu enter
    this->as_char = new char[lg + 1];///declaram memorie pt vectorul din this
    memcpy(this->as_char, other.as_char, lg + 1);///copiem in this vectorul as_char din other 
    other.as_char = nullptr;///stergem don other
}
...
{
    if (this->base10 < other.base10)  //1 daca e mai mic
    {
        return 1;
    }
    return 0; ///0 altfel
...
bool Number::operator>(const Number& other)
{
    if (this->base10 > other.base10)  //1 daca e mai mare
    {
        return 1;
    }
    return 0; ///0 altfel
...
bool Number::operator<=(const Number& other)
{
    if (this->base10 <= other.base10)  //1 daca e mai mic egal
    {
        return 1;
    }
    return 0; ///0 altfel
...
bool Number::operator>=(const Number& other)
{
    if (this->base10 >= other.base10)  //1 daca e mai mare egal
    {
        return 1;
    }
    return 0; ///0 altfel
...
bool Number::operator==(const Number& other)
{
    if (this->base10 == other.base10)  //1 daca sunt egale
    {
        return 1;
    }
    return 0; ///0 altfel
...
bool Number::operator!=(const Number& other)
{
    if (this->base10 != other.base10)  //1 daca nu sunt egale
    {
        return 1;
    }
    return 0; ///0 altfel
